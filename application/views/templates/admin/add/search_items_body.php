<h2 class="sub-header">Result items</h2>
  ...
  ?>
	<tr>
	  ...
	  <td>
		...
		Sudah promo
		<?php } else {?>
		<button data-button="<?php echo $value->id_items;?>" class="btn btn-success btn_promo">Promo</button>
		<?php } ?>
...
$(".btn_promo").click(function(){
	...
	$.ajax({
			url			: site_url + 'ajax/submit_promo',
			type		: 'post',
			dataType	: "JSON",
			data		: {q:data_btn},
