...
$(".report").click(function(){
	window.location="<?php echo site_url('apps/report');?>"
	  ...
	  <h2 class="sub-header">Report Page</h2>
	  <ul class="nav nav-tabs add_tabs" role="tablist">
        <li role="presentation" data-type="2" class="active"><a href="javascript:;">User</a></li>
	  ...
	  <div class="col-lg-12 normal_padding box_data_report" style="border-right:1px solid #ddd; border-left:1px solid #ddd; border-bottom:1px solid #ddd; padding:15px;">
		<?php echo $this->load->view('templates/admin/report/report_user_body');?>
	  </div>
...
<script>
	$(".add_tabs li").click(function(){
	 ...
	 $.ajax({
			url			: site_url + 'ajax/check_menu_report',
			type		: 'post',
			data		: {add_type:type},
			success		: function(data){
			
			$(".box_data_report").html(data);
